...
% overwritten.
\xcrefngermanSetNamesTableEntry{section}{in}{{die}{Sektion}{die}{Sektionen}}
                                            {{die}{Sektion}{die}{Sektionen}}
                                            {{der}{Sektion}{den}{Sektionen}}
                                            {{der}{Sektion}{der}{Sektionen}}
...
\emph{\gxcref[preposition=durch]{sec-examples}}.
